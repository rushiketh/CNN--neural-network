function im_h = CH4_R_SRCNN(model, im_b)
...
conv3_data2=rot90(conv3_data2,1);
...
conv3_data3=rot90(conv3_data3,2);
...
conv3_data4=rot90(conv3_data4,3);



%% SRCNN reconstruction
conv3_data2=rot90(conv3_data2,3);
conv3_data3=rot90(conv3_data3,2);
conv3_data4=rot90(conv3_data4,1);

im_h = (conv3_data1(:,:) +conv3_data2(:,:)+conv3_data3(:,:)+conv3_data4(:,:))/4+ biases_conv3;